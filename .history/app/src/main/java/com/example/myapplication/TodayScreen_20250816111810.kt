...
fun AssignmentStatusIndicator(
    ...
    val (icon, color, text) = when (status) {
        ...
        AssignmentStatus.PENDING -> Triple(Icons.Default.Schedule, MaterialTheme.colorScheme.primary, "Pending")
        AssignmentStatus.UPCOMING -> Triple(Icons.Default.AccessTime, MaterialTheme.colorScheme.onSurfaceVariant, "Upcoming")
    }
