...
fun ParentCareNavigationHost(
    ...
    startDestination: String = ParentCareDestination.System.DevMode.route,
...
private fun DevelopmentModeScreen(
    ...
    // Import and use the existing DevelopmentModeApp composable
    // but wire it up to navigation
