    ...
    Card(
        ...
        Column(
            ...
            missedMeds.forEach { missed ->
                Text(
                    text = "${missed.parent} missed ${missed.medication} (${missed.when})",
...
fun AssignmentStatusIndicator(
    ...
    val (icon, color, text) = when (status) {
        AssignmentStatus.COMPLETED -> Triple(Icons.Default.CheckCircle, Color.Green, "Done")
        AssignmentStatus.PENDING -> Triple(Icons.Default.Schedule, Color.Orange, "Pending")
        AssignmentStatus.UPCOMING -> Triple(Icons.Default.AccessTime, Color.Gray, "Upcoming")
    }
